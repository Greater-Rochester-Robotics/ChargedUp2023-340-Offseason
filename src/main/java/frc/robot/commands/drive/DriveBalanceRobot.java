...
public class DriveBalanceRobot extends CommandBase {
    ...
    public DriveBalanceRobot(boolean enableLateralControl) {
        ...
        balancePIDX = new PIDController(0.12, 0.0, 0.0);
        balancePIDY = new PIDController(0.12, 0.0, 0.0);
    }
    ...
    public void execute () {
        ...
        RobotContainer.swerveDrive.driveFieldRelative(
            awaySpeed,
            lateralSpeed, 
            0.0,//RobotContainer.swerveDrive.getCounterRotationPIDOut(startingYaw), 
            false
        );
        // }else{
