...
public final class GRRMath {
    ...
    public static double wrapAbout(double ref, double angle) {
        ...
        if (diff > Math.PI) return angle - (GRRMath.TWO_PI); else if (diff < -Math.PI) return angle + (GRRMath.TWO_PI); else return angle;
    }
     ...
     * @param value The value to round.
     * @param precision The precision to round to as a power of 10.
     * @return The rounded value.
     */
