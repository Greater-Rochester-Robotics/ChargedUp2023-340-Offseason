...
public class ChoreoHolonomicDriveController {
     ...
     */
    public ChoreoHolonomicDriveController(PIDController xController, PIDController yController, PIDController rotationController) {
    ...
    public ChassisSpeeds calculate(Pose2d currentPose, ChoreoTrajectoryState referenceState) {
        ...
        double rotationFeedback = this.rotationController.calculate(currentPose.getRotation().getRadians(), referenceState.heading);
