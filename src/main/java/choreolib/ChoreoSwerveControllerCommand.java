...
public class ChoreoSwerveControllerCommand extends Command {
    ...
    public void execute() {
        ...
        ChoreoTrajectoryState desiredState =
            this.trajectory.sample(currentTime, useAllianceColor && DriverStation.getAlliance().orElse(Alliance.Red) == Alliance.Red);
